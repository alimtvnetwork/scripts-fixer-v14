...
2. `### 🪟 Windows · PowerShell · skip latest-version probe`
   ```powershell
   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/scripts-fixer-v13/main/install.ps1)))
   ```
...
- NEVER use external repo URLs (e.g. coding-guidelines, GitMap). Always `alimtvnetwork/scripts-fixer-v13`.
