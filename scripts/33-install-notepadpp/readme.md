...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 33 — Install Notepadpp" width="128" height="128"/>

# Script 33 — Install Notepadpp
...
Implementation folder for **Script 33 — Install Notepadpp**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 33 install
```
...
- [Full spec](../../spec/33-install-notepadpp/readme.md)
