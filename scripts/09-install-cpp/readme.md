...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 09 — Install Cpp" width="128" height="128"/>

# Script 09 — Install Cpp
...
Implementation folder for **Script 09 — Install Cpp**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 09 install
```
...
- [Full spec](../../spec/09-install-cpp/readme.md)
