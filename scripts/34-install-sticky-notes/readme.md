...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 34 — Install Sticky Notes" width="128" height="128"/>

# Script 34 — Install Sticky Notes
...
Implementation folder for **Script 34 — Install Sticky Notes**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 34 install
```
...
- [Full spec](../../spec/34-install-sticky-notes/readme.md)
