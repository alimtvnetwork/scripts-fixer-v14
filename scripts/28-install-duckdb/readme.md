...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 28 — Install Duckdb" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-28-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 28 — Install Duckdb**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 28 install
```
...
- [Full spec](../../spec/28-install-duckdb/readme.md)
