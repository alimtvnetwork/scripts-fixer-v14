...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 12 — Install All Dev Tools" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-12-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 12 — Install All Dev Tools**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 12 install
```
...
- [Full spec](../../spec/12-install-all-dev-tools/readme.md)
