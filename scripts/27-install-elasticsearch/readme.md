...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 27 — Install Elasticsearch" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-27-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 27 — Install Elasticsearch**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 27 install
```
...
- [Full spec](../../spec/27-install-elasticsearch/readme.md)
