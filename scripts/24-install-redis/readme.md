...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 24 — Install Redis" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-24-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 24 — Install Redis**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 24 install
```
...
- [Full spec](../../spec/24-install-redis/readme.md)
