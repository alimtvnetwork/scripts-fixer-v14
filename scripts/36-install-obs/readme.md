...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 36 — Install Obs" width="128" height="128"/>

# Script 36 — Install Obs
...
Implementation folder for **Script 36 — Install Obs**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 36 install
```
...
- [Full spec](../../spec/36-install-obs/readme.md)
