...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 41 — Install Python Libs" width="128" height="128"/>

# Script 41 — Install Python Libs
...
Implementation folder for **Script 41 — Install Python Libs**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 41 install
```
...
- [Full spec](../../spec/41-install-python-libs/readme.md)
