...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 39 — Install Dotnet" width="128" height="128"/>

# Script 39 — Install Dotnet
...
Implementation folder for **Script 39 — Install Dotnet**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 39 install
```
...
- [Full spec](../../spec/39-install-dotnet/readme.md)
