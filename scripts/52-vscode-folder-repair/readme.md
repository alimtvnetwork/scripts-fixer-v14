...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 52 — Vscode Folder Repair" width="128" height="128"/>

# Script 52 — Vscode Folder Repair
...
Implementation folder for **Script 52 — Vscode Folder Repair**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 52 install
```
...
- [Full spec](../../spec/52-vscode-folder-repair/readme.md)
