...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 06 — Install Golang" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-06-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 06 — Install Golang**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 06 install
```
...
- [Full spec](../../spec/06-install-golang/readme.md)
