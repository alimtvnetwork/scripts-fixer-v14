...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 20 — Install Postgresql" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-20-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 20 — Install Postgresql**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 20 install
```
...
- [Full spec](../../spec/20-install-postgresql/readme.md)
