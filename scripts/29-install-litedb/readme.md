...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 29 — Install Litedb" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-29-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 29 — Install Litedb**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 29 install
```
...
- [Full spec](../../spec/29-install-litedb/readme.md)
