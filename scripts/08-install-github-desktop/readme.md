...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 08 — Install Github Desktop" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-08-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 08 — Install Github Desktop**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 08 install
```
...
- [Full spec](../../spec/08-install-github-desktop/readme.md)
