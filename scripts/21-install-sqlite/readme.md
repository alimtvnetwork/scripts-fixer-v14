...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 21 — Install Sqlite" width="128" height="128"/>
...
Implementation folder for **Script 21 — Install Sqlite**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 21 install
```
...
- [Full spec](../../spec/21-install-sqlite/readme.md)
