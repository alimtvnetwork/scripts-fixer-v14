...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 47 — Install Ubuntu Font" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-47-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 47 — Install Ubuntu Font**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 47 install
```
...
- [Full spec](../../spec/47-install-ubuntu-font/readme.md)
