...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 37 — Install Windows Terminal" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-37-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 37 — Install Windows Terminal**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 37 install
```
...
- [Full spec](../../spec/37-install-windows-terminal/readme.md)
