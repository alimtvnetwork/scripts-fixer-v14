...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 14 — Install Winget" width="128" height="128"/>
...
Implementation folder for **Script 14 — Install Winget**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 14 install
```
...
- [Full spec](../../spec/14-install-winget/readme.md)
