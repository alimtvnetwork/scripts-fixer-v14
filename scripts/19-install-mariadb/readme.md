...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 19 — Install Mariadb" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-19-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 19 — Install Mariadb**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 19 install
```
...
- [Full spec](../../spec/19-install-mariadb/readme.md)
