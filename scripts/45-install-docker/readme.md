...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 45 — Install Docker" width="128" height="128"/>

# Script 45 — Install Docker
...
Implementation folder for **Script 45 — Install Docker**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 45 install
```
...
- [Full spec](../../spec/45-install-docker/readme.md)
