...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 17 — Install Powershell" width="128" height="128"/>
...
Implementation folder for **Script 17 — Install Powershell**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 17 install
```
...
- [Full spec](../../spec/17-install-powershell/readme.md)
