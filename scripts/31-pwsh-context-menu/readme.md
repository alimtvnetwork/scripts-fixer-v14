...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 31 — Pwsh Context Menu" width="128" height="128"/>

# Script 31 — Pwsh Context Menu
...
Implementation folder for **Script 31 — Pwsh Context Menu**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 31 install
```
...
- [Full spec](../../spec/31-pwsh-context-menu/readme.md)
