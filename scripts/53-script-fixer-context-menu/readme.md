...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 53 — Script Fixer Context Menu" width="128" height="128"/>
...
Implementation folder for **Script 53 — Script Fixer Context Menu**. The full design contract lives in the spec.
...
- [Full spec](../../spec/53-script-fixer-context-menu/readme.md)
