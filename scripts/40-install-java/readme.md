...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 40 — Install Java" width="128" height="128"/>

# Script 40 — Install Java
...
Implementation folder for **Script 40 — Install Java**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 40 install
```
...
- [Full spec](../../spec/40-install-java/readme.md)
