...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 16 — Install Php" width="128" height="128"/>
...
Implementation folder for **Script 16 — Install Php**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 16 install
```
...
- [Full spec](../../spec/16-install-php/readme.md)
