...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 18 — Install Mysql" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-18-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 18 — Install Mysql**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 18 install
```
...
- [Full spec](../../spec/18-install-mysql/readme.md)
