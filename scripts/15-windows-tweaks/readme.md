...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 15 — Windows Tweaks" width="128" height="128"/>
...
Implementation folder for **Script 15 — Windows Tweaks**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 15 install
```
...
- [Full spec](../../spec/15-windows-tweaks/readme.md)
