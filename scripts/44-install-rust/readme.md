...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 44 — Install Rust" width="128" height="128"/>
...
Implementation folder for **Script 44 — Install Rust**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 44 install
```
...
- [Full spec](../../spec/44-install-rust/readme.md)
