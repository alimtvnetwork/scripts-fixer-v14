...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 02 — Install Package Managers" width="128" height="128"/>
...
Implementation folder for **Script 02 — Install Package Managers**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 02 install
```
...
- [Full spec](../../spec/02-install-package-managers/readme.md)
