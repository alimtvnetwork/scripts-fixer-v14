...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 26 — Install Neo4j" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-26-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 26 — Install Neo4j**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 26 install
```
...
- [Full spec](../../spec/26-install-neo4j/readme.md)
