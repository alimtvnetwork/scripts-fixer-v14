...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 22 — Install Mongodb" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-22-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 22 — Install Mongodb**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 22 install
```
...
- [Full spec](../../spec/22-install-mongodb/readme.md)
