...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 04 — Install Pnpm" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-04-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 04 — Install Pnpm**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 04 install
```
...
- [Full spec](../../spec/04-install-pnpm/readme.md)
