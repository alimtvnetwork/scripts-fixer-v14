...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 38 — Install Flutter" width="128" height="128"/>
...
Implementation folder for **Script 38 — Install Flutter**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 38 install
```
...
- [Full spec](../../spec/38-install-flutter/readme.md)
