...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 05 — Install Python" width="128" height="128"/>
...
Implementation folder for **Script 05 — Install Python**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 05 install
```
...
- [Full spec](../../spec/05-install-python/readme.md)
