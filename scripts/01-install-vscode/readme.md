...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 01 — Install Vscode" width="128" height="128"/>

# Script 01 — Install Vscode
...
Implementation folder for **Script 01 — Install Vscode**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 01 install
```
...
- [Full spec](../../spec/01-install-vscode/readme.md)
