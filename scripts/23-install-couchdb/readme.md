...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 23 — Install Couchdb" width="128" height="128"/>
...
[![Script](https://img.shields.io/badge/Script-23-8b5cf6)](https://github.com/alimtvnetwork/gitmap-v6/blob/main/scripts/registry.json)
...
Implementation folder for **Script 23 — Install Couchdb**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 23 install
```
...
- [Full spec](../../spec/23-install-couchdb/readme.md)
