...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 42 — Install Ollama" width="128" height="128"/>
...
Implementation folder for **Script 42 — Install Ollama**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 42 install
```
...
- [Full spec](../../spec/42-install-ollama/readme.md)
