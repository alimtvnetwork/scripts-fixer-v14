...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 32 — Install Dbeaver" width="128" height="128"/>

# Script 32 — Install Dbeaver
...
Implementation folder for **Script 32 — Install Dbeaver**. The full design contract lives in the spec.

## Quick start

```powershell
# From repo root
.\run.ps1 -I 32 install
```
...
- [Full spec](../../spec/32-install-dbeaver/readme.md)
