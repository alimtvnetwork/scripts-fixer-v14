...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Spec 25 — Install Cassandra" width="128" height="128"/>

# Spec 25 — Install Cassandra
...
1. **Dev directory** (default): `E:\dev-tool\cassandra`
