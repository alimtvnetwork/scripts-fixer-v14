...
### Fixed: User-facing scripts-fixer-v14 install URLs migrated to gitmap-v6

Three concrete user-facing references to the legacy `scripts-fixer-v14` repo slug were updated to `gitmap-v6`:
...
A repo-wide grep confirms zero remaining live install URLs point at `scripts-fixer-v14`.
...
- One-liner install + manual-clone URLs pointed at the wrong repo (`scripts-fixer-v14`); switched to `gitmap-v6` (lines 78, 84, 90, 91).
