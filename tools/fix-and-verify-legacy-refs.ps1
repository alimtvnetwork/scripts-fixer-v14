...
#    2. APPLY the rewrite (scripts-fixer-v13/v9/v10 -> v11) with timestamped
...
Write-Fail1 'scanner reports FAIL -- legacy scripts-fixer-v13/v9/v10 references still present'
